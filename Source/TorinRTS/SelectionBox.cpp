...
void ASelectionBox::Start(FVector Position, const FRotator Rotation)
{
	...
	//Set Start position as a fixed position reference
...
void ASelectionBox::End(const bool bSelect, const bool bAddOnly)
{
	...
	//Select the now filtered list of actors with centers bound by the collider
...
void ASelectionBox::Manage()
{
	...
	{
		//Get Actor center and transform into local space of collider
		...
		//Get local extent of the collider
	...
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	//Check it is a selectable unit, if so, add to inbox array
